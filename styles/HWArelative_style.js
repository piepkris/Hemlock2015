var ranges_HWArelative = [[0.000000, 0.100000, [ new ol.style.Style({
...
[0.900000, 1.000000, [ new ol.style.Style({
                    ...
                    var styleCache_HWArelative={}
                    var style_HWArelative = function(feature, resolution){
                        var value = feature.get("HWArelative");
                        var style = ranges_HWArelative[0][2];
                            for (i = 0; i < ranges_HWArelative.length; i++){
                                var range = ranges_HWArelative[i];
                        ...
                        if (!styleCache_HWArelative[key]){
                            ...
                            styleCache_HWArelative[key] = new ol.style.Style({"text": text});
                        }
                        var allStyles = [styleCache_HWArelative[key]];
